...
export const USER_DB_NAME = process.env.DB_NAME || 'USERS_DB';
export const USER_DB_USER = process.env.DB_USER || 'root';
export const USER_DB_PASSWORD = process.env.DB_PASSWORD || 'aaaa4321';
export const USER_DB_HOST = process.env.DB_HOST || '127.0.0.1';
export const USER_DB_PORT = process.env.DB_PORT || '3306';
